...
function greet(user){
    console.log(`Hey ${users.name}, your age is ${users.age}!`);
    if ( user.age >= 18){
      console.log(`As your age is ${users.age}, You're an adult, So you can vote!`);
    } else {
      console.log(`As your age is ${users.age}, You're not an adult, So you can't vote!`);
    }
  }
...
console.log(`Hello my name is ${userss.name}, 
my age is ${userss.age} and I'm a ${userss.gender} candidate`);