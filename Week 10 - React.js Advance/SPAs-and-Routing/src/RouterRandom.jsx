// This SPA handles all unmatched routes in the application.
// It renders a 404 (Page Not Found) error page when the user tries to access a route that does not exist.
        ...
        <div>
            ...
            <BrowserRouter>
                ...
                <Routes>
                    ...
                    {/* to make an error page/ 404 page, I can use a star(*) in the path and the element which is having a component called ErrorPage */}
